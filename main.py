            ...
            if ALL_RESULTS:
                ...
                try:
                    ...
                    try:
                        ...
                        wh_rep = get_whale_movement_report_string()
                        
                        # Generate Heatmap for Web Dashboard
                    ...
                    # YOUTUBE ALPHA (DISABLED to prevent API blocks)
                    # try:
                    #     import youtube_analyzer
                    ...
                    web_reports["YouTube Alpha"] = "⛔ YouTube Analysis is manually disabled due to API limits."
